                            ...
                            <div class="card-body">
                                <form class="theme-form mega-form" action="{{ route('update.payment_method', $payment_method->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{$payment_method->name_ar}}" name="name_ar" />
                                        @error('name_ar')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="name_en" value="{{$payment_method->name_en}}"/>
                                        @error('paid')
                                            <span class=" text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
