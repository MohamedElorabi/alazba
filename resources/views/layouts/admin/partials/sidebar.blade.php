                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/properties') }}" href="javascript:void(0)"><i
                                data-feather="box"></i><span>Properties</span></a>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/ui-kits') }}" href="javascript:void(0)"><i
                                data-feather="box"></i><span>Ui Kits</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/ui-kits') }};">
                            <li><a href="{{ route('state-color') }}" class="{{ routeActive('state-color') }}">State
                                    color</a></li>
                            ...
                            <li><a href="{{ route('tag-pills') }}" class="{{ routeActive('tag-pills') }}">Tag &
                                    pills</a></li>
                            ...
                            <li><a href="{{ route('according') }}"
                                    class="{{ routeActive('according') }}">Accordion</a></li>
                            <li>
                                ...
                                <ul class="nav-sub-childmenu submenu-content"
                                    ...
                                    <li><a href="{{ route('tab-bootstrap') }}"
                                            class="{{ routeActive('tab-bootstrap') }}">Bootstrap Tabs</a></li>
                                    <li><a href="{{ route('tab-material') }}"
                                            class="{{ routeActive('tab-material') }}">Line Tabs</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ route('navs') }}" class="{{ routeActive('navs') }}">Navs</a></li>
                            <li><a href="{{ route('box-shadow') }}"
                                    class="{{ routeActive('box-shadow') }}">Shadow</a></li>
                            <li><a href="{{ route('list') }}" class="{{ routeActive('list') }}">Lists</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/bonus-ui') }}" href="javascript:void(0)"><i
                        ...
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/bonus-ui') }};">
                            <li><a href="{{ route('scrollable') }}"
                                    class="{{ routeActive('scrollable') }}">Scrollable</a></li>
                            ...
                            <li><a href="{{ route('pagination') }}"
                                    class="{{ routeActive('pagination') }}">Pagination</a></li>
                            <li><a href="{{ route('steps') }}" class="{{ routeActive('steps') }}">Steps</a></li>
                            <li><a href="{{ route('breadcrumb') }}"
                                    class="{{ routeActive('breadcrumb') }}">Breadcrumb</a></li>
                            ...
                            <li><a href="{{ route('tabbed-card') }}"
                                    class="{{ routeActive('tabbed-card') }}">Tabbed Card</a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-sub-childmenu submenu-content"
                                    ...
                                    <li><a href="{{ route('timeline-v-1') }}"
                                            class="{{ routeActive('timeline-v-1') }}">Timeline 1</a></li>
                                    <li><a href="{{ route('timeline-v-2') }}"
                                            class="{{ routeActive('timeline-v-2') }}">Timeline 2</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/builders') }}" href="javascript:void(0)"><i
                        ...
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/builders') }};">
                            <li><a href="{{ route('form-builder-1') }}"
                                    class="{{ routeActive('form-builder-1') }}">Form Builder 1</a></li>
                            <li><a href="{{ route('form-builder-2') }}"
                                    class="{{ routeActive('form-builder-2') }}">Form Builder 2</a></li>
                            <li><a href="{{ route('pagebuild') }}" class="{{ routeActive('pagebuild') }}">Page
                                    Builder</a></li>
                            <li><a href="{{ route('button-builder') }}"
                                    class="{{ routeActive('button-builder') }}">Button Builder</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/animation') }}" href="javascript:void(0)"><i
                                data-feather="cloud-drizzle"></i><span>Animation</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/animation') }};">
                            <li><a href="{{ route('animate') }}" class="{{ routeActive('animate') }}">Animate</a>
                            </li>
                            <li><a href="{{ route('scroll-reval') }}"
                                    class="{{ routeActive('scroll-reval') }}">Scroll Reveal</a></li>
                            <li><a href="{{ route('aos') }}" class="{{ routeActive('aos') }}">AOS animation</a>
                            </li>
                            <li><a href="{{ route('tilt') }}" class="{{ routeActive('tilt') }}">Tilt Animation</a>
                            </li>
                            <li><a href="{{ route('wow') }}" class="{{ routeActive('wow') }}">Wow Animation</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/icons') }};">
                            <li><a href="{{ route('flag-icon') }}" class="{{ routeActive('flag-icon') }}">Flag
                                    icon</a></li>
                            <li><a href="{{ route('font-awesome') }}"
                                    class="{{ routeActive('font-awesome') }}">Fontawesome Icon</a></li>
                            <li><a href="{{ route('ico-icon') }}" class="{{ routeActive('ico-icon') }}">Ico
                                    Icon</a></li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/buttons') }}" href="javascript:void(0)"><i
                                data-feather="cloud"></i><span>Buttons</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/buttons') }};">
                            <li><a href="{{ route('buttons') }}" class="{{ routeActive('buttons') }}">Default
                                    Style</a></li>
                            <li><a href="{{ route('buttons-flat') }}"
                                    class="{{ routeActive('buttons-flat') }}">Flat Style</a></li>
                            <li><a href="{{ route('buttons-edge') }}"
                                    class="{{ routeActive('buttons-edge') }}">Edge Style</a></li>
                            <li><a href="{{ route('raised-button') }}"
                                    class="{{ routeActive('raised-button') }}">Raised Style</a></li>
                            <li><a href="{{ route('button-group') }}"
                                    class="{{ routeActive('button-group') }}">Button Group</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/charts') }}" href="javascript:void(0)"><i
                                data-feather="bar-chart"></i><span>Charts</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/charts') }};">
                            <li><a href="{{ route('chart-apex') }}" class="{{ routeActive('chart-apex') }}">Apex
                                    Chart</a></li>
                            <li><a href="{{ route('chart-google') }}"
                                    class="{{ routeActive('chart-google') }}">Google Chart</a></li>
                            <li><a href="{{ route('chart-sparkline') }}"
                                    class="{{ routeActive('chart-sparkline') }}">Sparkline chart</a></li>
                            <li><a href="{{ route('chart-flot') }}" class="{{ routeActive('chart-flot') }}">Flot
                                    Chart</a></li>
                            <li><a href="{{ route('chart-knob') }}" class="{{ routeActive('chart-knob') }}">Knob
                                    Chart</a></li>
                            <li><a href="{{ route('chart-morris') }}"
                                    class="{{ routeActive('chart-morris') }}">Morris Chart</a></li>
                            <li><a href="{{ route('chartjs') }}" class="{{ routeActive('chartjs') }}">Chatjs
                                    Chart</a></li>
                            <li><a href="{{ route('chartist') }}" class="{{ routeActive('chartist') }}">Chartist
                                    Chart</a></li>
                            <li><a href="{{ route('chart-peity') }}"
                                    class="{{ routeActive('chart-peity') }}">Peity Chart</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/form-controls') }}"
                            href="javascript:void(0)"><i data-feather="sliders"></i><span>Form Controls </span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/form-controls') }};">
                            <li><a href="{{ route('form-validation') }}"
                                    class="{{ routeActive('form-validation') }}">Form Validation</a></li>
                            <li><a href="{{ route('base-input') }}" class="{{ routeActive('base-input') }}">Base
                                    Inputs</a></li>
                            <li><a href="{{ route('radio-checkbox-control') }}"
                                    class="{{ routeActive('radio-checkbox-control') }}">Checkbox & Radio</a></li>
                            <li><a href="{{ route('input-group') }}"
                                    class="{{ routeActive('input-group') }}">Input Groups</a></li>
                            <li><a href="{{ route('megaoptions') }}" class="{{ routeActive('megaoptions') }}">Mega
                                    Options </a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/form-widgets') }}"
                            href="javascript:void(0)"><i data-feather="package"></i><span>Form Widgets</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/form-widgets') }};">
                            <li><a href="{{ route('datepicker') }}"
                                    class="{{ routeActive('datepicker') }}">Datepicker</a></li>
                            <li><a href="{{ route('time-picker') }}"
                                    class="{{ routeActive('time-picker') }}">Timepicker</a></li>
                            <li><a href="{{ route('datetimepicker') }}"
                                    class="{{ routeActive('datetimepicker') }}">Datetimepicker</a></li>
                            <li><a href="{{ route('daterangepicker') }}"
                                    class="{{ routeActive('daterangepicker') }}">Daterangepicker</a></li>
                            <li><a href="{{ route('touchspin') }}"
                                    class="{{ routeActive('touchspin') }}">Touchspin</a></li>
                            <li><a href="{{ route('select2') }}" class="{{ routeActive('select2') }}">Select2</a>
                            </li>
                            <li><a href="{{ route('switch') }}" class="{{ routeActive('switch') }}">Switch</a>
                            </li>
                            <li><a href="{{ route('typeahead') }}"
                                    class="{{ routeActive('typeahead') }}">Typeahead</a></li>
                            <li><a href="{{ route('clipboard') }}"
                                    class="{{ routeActive('clipboard') }}">Clipboard </a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/form-layout') }}"
                            href="javascript:void(0)"><i data-feather="layout"></i><span>Form layout</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/form-layout') }};">
                            <li><a href="{{ route('default-form') }}"
                                    class="{{ routeActive('default-form') }}">Default Forms</a></li>
                            <li><a href="{{ route('form-wizard') }}" class="{{ routeActive('form-wizard') }}">Form
                                    Wizard 1</a></li>
                            <li><a href="{{ route('form-wizard-two') }}"
                                    class="{{ routeActive('form-wizard-two') }}">Form Wizard 2</a></li>
                            <li><a href="{{ route('form-wizard-three') }}"
                                    class="{{ routeActive('form-wizard-three') }}">Form Wizard 3</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content"
                            style="display: {{ prefixBlock('/bootstrap-tables') }};">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/data-tables') }}"
                            href="javascript:void(0)"><i data-feather="database"></i><span>Data Tables </span></a>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('jsgrid-table') }}"
                            href="{{ route('jsgrid-table') }}"><i data-feather="file-text"></i><span>Js Grid
                                Table</span></a>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('file-manager') }}"
                            href="{{ route('file-manager') }}"><i data-feather="git-pull-request"></i><span>File
                                manager</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('kanban') }}"
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/email') }}" href="javascript:void(0)"><i
                                data-feather="mail"></i><span>Email</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/email') }};">
                            <li><a href="{{ route('email_inbox') }}" class="{{ routeActive('email_inbox') }}">Mail
                                    Inbox</a></li>
                            <li><a href="{{ route('email_read') }}" class="{{ routeActive('email_read') }}">Read
                                    mail</a></li>
                            <li><a href="{{ route('email_compose') }}"
                                    class="{{ routeActive('email_compose') }}">Compose</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('bookmark') }}"
                            href="{{ route('bookmark') }}"><i data-feather="heart"></i><span>Bookmarks</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('contacts') }}"
                            href="{{ route('contacts') }}"><i data-feather="list"></i><span>Contacts</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('task') }}"
                            href="{{ route('task') }}"><i data-feather="check-square"></i><span>Tasks</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('calendar-basic') }}"
                            href="{{ route('calendar-basic') }}"><i data-feather="calendar"></i><span>Calender
                            </span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('social-app') }}"
                            href="{{ route('social-app') }}"><i data-feather="zap"></i><span>Social App</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('to-do') }}"
                            href="{{ route('to-do') }}"><i data-feather="clock"></i><span>To-Do</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('search') }}"
                            href="{{ route('search') }}"><i data-feather="search"></i><span>Search Result</span></a>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                            <h6>Pages</h6>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{ routeActive('internationalization') }}"
